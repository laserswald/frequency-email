...
class DescriptionPage(WizardPage):
	...
	def __init__(self, text="Text", *arg):
		self.text = text
		super(DescriptionPage, this).__init__(arg);
	...
	def setup_widgets(self):
        ...
        self.textwidget = Message(self, text=self.text)
...
class TextInputPage(WizardPage):

    def __init__(self, labeltext="derp"):
        super(TextInputPage, this).__init__(arg, kw)
        self.setup_text()
...
class Wizard(object):
	def __init__(self, master, title):
		...
		self.pageframe.config(borderwidth=1, relief="ridge")
...
if __name__ == "__main__":
	...
	page1 = DescriptionPage(wiz)
	page2 = DescriptionPage(wiz, "Page 2", "This is going on page 2.")
	wiz.add_page(page1)
	wiz.add_page(page2)
	wiz.begin()
	root.mainloop()
